...
-- Diagnostic keymaps
-- quick fix is replaced by trouble
...
vim.keymap.set('n', 'bx', '<cmd>bdelete<CR>', { desc = 'Close current buffer' })
...
require('lazy').setup({
  ...
  --     vim.keymap.set('n', '<leader>sb', builtin.buffers, { desc = '[S]earch through [B]uffers' })
  --
